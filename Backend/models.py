...
class Boards(Base):
    ...
    Board_ID = Column(Integer, nullable=False, unique=True,
                      primary_key=True, autoincrement=True)
    Name = Column(String, nullable=False)
    Description = Column(String, nullable=True)
    Group_ID = Column(Integer, ForeignKey(
...
class Questions(Base):
    ...
    Questions_ID = Column(Integer, nullable=False, unique=True,
                          primary_key=True, autoincrement=True)
...
class Feedback(Base):
    ...
    Feedback_ID = Column(Integer, nullable=False, unique=True,
                         primary_key=True, autoincrement=True)
    Content = Column(String, nullable=False)
    Questions_ID = Column(Integer, ForeignKey(
        "QuestionsModel.Questions_ID"), nullable=False)
    User_ID = Column(Integer, ForeignKey("UsersModel.User_ID"), nullable=False)
...
class Reaction(Base):
    ...
    Reaction_ID = Column(Integer, nullable=False, unique=True,
                         primary_key=True, autoincrement=True)
    Reaction_value = Column(Boolean, nullable=True)
    Feedback_ID = Column(Integer, ForeignKey(
        "FeedbackModel.Feedback_ID"), nullable=False)
    User_ID = Column(Integer, ForeignKey("UsersModel.User_ID"), nullable=False)
